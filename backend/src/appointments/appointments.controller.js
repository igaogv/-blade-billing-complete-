...
var AppointmentsController = function () {
    var _classDecorators = [(0, common_1.Controller)('appointments'), (0, common_1.UseGuards)(auth_guard_1.AuthGuard)];
    ...
    var AppointmentsController = _classThis = /** @class */ (function () {
        ...
        AppointmentsController_1.prototype.create = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.appointmentsService.create(data)];
                });
            });
        };
        AppointmentsController_1.prototype.findAll = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.appointmentsService.findAll()];
                });
            });
        };
        ...
        AppointmentsController_1.prototype.update = function (id, data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.appointmentsService.update(id, data)];
                });
            });
        };
        AppointmentsController_1.prototype.delete = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.appointmentsService.delete(id)];
                });
            });
        };
