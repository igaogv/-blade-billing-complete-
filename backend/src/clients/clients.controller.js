...
var ClientsController = function () {
    var _classDecorators = [(0, common_1.Controller)('clients'), (0, common_1.UseGuards)(auth_guard_1.AuthGuard)];
    ...
    var ClientsController = _classThis = /** @class */ (function () {
        ...
        ClientsController_1.prototype.create = function (createClientDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.clientsService.create(createClientDto)];
                });
            });
        };
        ClientsController_1.prototype.findAll = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.clientsService.findAll()];
                });
            });
        };
        ClientsController_1.prototype.findOne = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.clientsService.findOne(id)];
                });
            });
        };
        ClientsController_1.prototype.update = function (id, updateClientDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.clientsService.update(id, updateClientDto)];
                });
            });
        };
        ClientsController_1.prototype.delete = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.clientsService.delete(id)];
                });
            });
        };
